...
/*   Updated: 2018/02/28 01:39:20 by asarandi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	routine(t_asm *a)
{
	...
	{
		ft_printf("{yellow}WARNING:{eoc} prog size (%d) ", a->prog_size);
	...
	else
	{
		...
		ft_printf("{green}SUCCESS:{eoc} writing output program to %s\n", of);
